...
new.dataset.folder <- "./datasets/feature-engineering/v1.5/"
new.dataset.name <- "competencia1_2022_fe_v1.5.csv"

rules.file.path <- "./exp/KA4120/v1.5/FeatureEngineering/rules.v1.5.txt"
