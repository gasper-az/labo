...
PARAM$experimento  <- "HT7236_10rep_5kf"
...
PARAM$hyperparametertuning$iteraciones <- 50 ## Hago 50 iteraciones en vez de 100
...
PARAM$hyperparametertuning$semillas_azar <- c(763381, 763391, 763403, 763409, 763417, 763423, 763429, 763447, 763457, 763471)
...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  for (seed in PARAM$hyperparametertuning$semillas_azar) {
    gc()  #libero memoria
