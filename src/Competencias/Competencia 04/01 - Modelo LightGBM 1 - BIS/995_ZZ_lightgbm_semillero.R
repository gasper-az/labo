...
PARAM <- list()
PARAM$experimento <- "ZZ9410_semillerio_compFinal_modelo01_bis"
PARAM$exp_input <- "HT9420_compFinal_modelo01_bis"

PARAM$modelo <- 1 # se usa el mejor de la OB, pero a futuro podria variar esto
PARAM$semilla_primos <- 763369
...
# TODO: ESTO ANTES ESTABA EN EL FOR
