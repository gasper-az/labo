...
PARAM  <- list()
PARAM$experimento  <- "ZZ9420_compFinal_modelo07" # TODO: atenti con este nombre. Ya debe existir esta carpeta. Se mejorará en futuras versiones del script.
PARAM$exp_input  <- "HT9420_compFinal_modelo07" # TODO: atenti con este nombre.
PARAM$model_file_name <- "todo.model"   # TODO: acá debe ir el nombre del modelo creado (debe estar en la misma carpeta de PARAM$experimento. Se mejorará en futuras versiones del script)
