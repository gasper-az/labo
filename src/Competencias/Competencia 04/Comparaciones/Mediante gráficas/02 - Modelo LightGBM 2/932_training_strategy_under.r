...
PARAM  <- list()
PARAM$experimento <- "TS9320_compFinal_modelo02_public_vs_private"
...
PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103 )
PARAM$train$validation   <- c( 202104 )
PARAM$train$testing      <- c( 202105 ) # último mes con clase
