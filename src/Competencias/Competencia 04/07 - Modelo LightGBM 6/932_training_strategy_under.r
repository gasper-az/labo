...
PARAM  <- list()
PARAM$experimento <- "TS9320_compFinal_modelo07"

PARAM$exp_input  <- "FE9250_compFinal_modelo07"

PARAM$future       <- c( 202109 ) # mes a predecir

PARAM$final_train  <- c( 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107 )

PARAM$train$training     <- c( 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )
