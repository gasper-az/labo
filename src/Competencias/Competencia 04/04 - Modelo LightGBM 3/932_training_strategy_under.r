...
PARAM  <- list()
PARAM$experimento <- "TS9320_compFinal_modelo04"

PARAM$exp_input  <- "FE9250_compFinal_modelo04"

PARAM$future       <- c( 202109 ) # mes a predecir

PARAM$final_train  <- c( 201904, 201905, 201906, 201907, 201908, 201909, 202003, 202004, 202005, 202007, 202008, 202009 )

sPARAM$train$training     <- c( 201904, 201905, 201906, 201907, 201908, 201909, 202003, 202004, 202005, 202007 )
PARAM$train$validation   <- c( 202008 )
