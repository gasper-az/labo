...
PARAM <- list()
PARAM$base_dir <- "C:\\uba\\repos\\labo\\src\\Competencias\\Competencia 04\\10 - Ensamble Semilleros"
PARAM$semillerios_dir <- "ZZAVG"
PARAM$avg_semillerios_files <- c("promedio.semillas.modelo6.csv", "promedio.semillas.modelo7.csv")
PARAM$envios_dir <- "envios"
PARAM$base_file_name <- "ensamble_semillerio_modelos_6_7"
